\section{\fontsize{12}{15}\selectfont Discussion and Conclusion}
...
\citeA{spritz} also claims to increase reading speeds by removing the need to saccade, since processing of visual inputs are halted. However, since lexical processing runs in parallel 
