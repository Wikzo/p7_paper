...
Spritz and similar speed-reading apps might prove useful for less-complex material, but as stated by \citeA{time_spritz}, if we want to get a deeper understanding of a given text, \emph{"reading with an app like Spritz allows us only to read simply, foolishly fast."}
