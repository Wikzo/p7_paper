...
To evaluate the usage of FCT, we chose to focus on evaluating whether or not the tool allows the artists to successfully perform the tasks that the tool was originally designed for (mentioned in Section \ref{PD_Findings}).
