...
Creating a framing while having another framing selected connects the two. This connection is needed for manipulating the interpolation.
\textbf{MATHIAS, SKRIV LIDT OM GRAPH EDITOR HER: This is achived using the built-in graph editor of Unity.}
