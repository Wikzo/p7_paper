...
\subsubsection{Demographic and Introduction} %% <--- tripple sub!
...
\subsubsection{Basic Navigation} %% <--- tripple sub!
...
\subsubsection{Training}  %% <--- tripple sub!
...
\subsubsection{Tasks}%% <--- tripple sub!
...
\subsubsection{Creative} %% <--- tripple sub!
...
\subsubsection{Post-test Questionnaire} %% <--- tripple sub!
